<aside id="sidebar" class="sidebar sidebar-open bg-red-500 text-white flex flex-col">
    <nav class="flex-grow p-1">
        <ul class="space-y-4">
            <li>
                <a href="#" class="flex items-center p-2 rounded-md hover:bg-red-400">
                    <div class="nav-icon">
            ...
            <li>
                <a href="#" class="flex items-center p-2 rounded-md hover:bg-red-400">
                    <div class="nav-icon">
                        <svg  xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" stroke-width="2"  style="width: 24px; height: 24px; stroke: currentColor; fill: none;">
    ...
    <div class="p-1">
        <button class="flex items-center text-black rounded p-2 hover:bg-yellow-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
            </svg>
            <span class="nav-text ml-2">LogOut</span>
        </button>
    </div>
</aside>