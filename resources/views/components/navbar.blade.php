    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img class="size-8" src=https://github.com/Risal720/Homestay_Barijekaden/blob/main/public/image/logo.png alt="Your Company">
            {{-- <img src="{{ asset('images/' . $filename) }}" alt="Gambar"> --}}
          </div>
