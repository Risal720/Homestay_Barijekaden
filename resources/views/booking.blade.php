    ...
    <head>
        ...
        <style>
            ...
            .step-item.completed .step-circle {
                ...
                /* Darker green for completed step */
            }
        ...
        <main class="main-content-wrapper">
            ...
            <div class="booking-layout">
                <div class="form-section">
                    <h2>Isi Data</h2>
                    <p class="text-gray-600 mb-6 text-sm">Silahkan masukan informasi pemesanan anda melalui formulir
                        pemesanan dibawah ini. Pastikan terisi dengan benar supaya memudahkan proses pemesanan kamar.
                    </p>
                    ...
                    <form id="bookingForm" class="space-y-5">
                        <div class="form-group">
                            ...
                            <input type="text" id="namaKontak" name="namaKontak"
                                placeholder="Isi nama pemesan sesuai KTP/Paspor/SIM (tanpa tanda baca/gelar)" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="noHandphone" name="noHandphone"
                                placeholder="Masukan nomor handphone kontak contoh: +62812345600" required>
                            <p id="noHandphoneError" class="error-message hidden"></p>
                        </div>

                        <div class="form-group">
                            <label for="emailKontak">Email Kontak</label>
                            <input type="email" id="emailKontak" name="emailKontak"
                                placeholder="Masukan email yang benar contoh: user@example.com" required>
                            <p id="emailKontakError" class="error-message hidden"></p>
                        </div>

                        <div class="form-group">
                            <label for="namaTamu">Nama Tamu</label>
                            <input type="text" id="namaTamu" name="namaTamu"
                                placeholder="Isi nama pemesan sesuai KTP/Paspor/SIM (tanpa tanda baca/gelar), kosongkan bila sama dengan pemesan">
                            <p id="namaTamuError" class="error-message hidden"></p>
                        </div>

                        <div class="form-group">
                            <label for="permintaanKhusus">Permintaan Khusus (optional)</label>
                            <textarea id="permintaanKhusus" name="permintaanKhusus"
                                placeholder="Catatan: Permintaan spesifik bergantung pada ketersediaan setiap hotel dan tidak dapat dijamin. Check-in awal atau Transfer Bandara dapat menimbulkan biaya ekstra. Silakan hubung pihak hotel untuk memastikan."
                                rows="4"></textarea>
                        </div>

                        <div class="checkbox-group">
                            <input type="checkbox" id="agreeTerms" name="agreeTerms" required>
                            <label for="agreeTerms">Saya telah membaca dan menyetujui Syarat dan Ketentuan yang
                                berlaku.</label>
                ...
                <div class="summary-section">
                    ...
                    <div class="mb-4">
                        <img src="https://placehold.co/400x250/E0E0E0/333333?text=Gambar%20Kamar" alt="Gambar Kamar"
                    ...
                    <div class="help-section">
                        <h3>Butuh Bantuan?</h3>
                        <p>Kami siap melayani anda dan membantu anda mendapatkan kamar yang terbaik untuk liburan anda,
                            jangan sungkan untuk hubungi kami.</p>
                ...
                bookingForm.addEventListener('submit', async function(event) {
                    ...
                    if (isValid) {
                        ...
                        try {
                            ...
                            const apiUrl =
                                `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${apiKey}`; // Placeholder API
                            ...
                            if (response.ok) {
                                ...
                                alert('Terjadi kesalahan saat pemesanan: ' + (errorData.message ||
                                    'Silakan coba lagi.'));
                            }
                        } catch (error) {
