    ...
    <head>
        <style>
            ...
            html .body {
                ...
                /* Penting untuk konsistensi model box */
                overflow-x: hidden;
                /* Tambahkan ini sebagai pengaman tambahan jika perlu */
            }
                        ...
                        function showError(element, message) {
                            ...
                            function hideError(element) {
                                ...
                                function populateDays() {
                                    ...
                                    daySelect.innerHTML =
                                    '<option value="">Please select a day</option>'; // Clear existing options
                                ...
                                form.addEventListener('submit', async function(event) {
                                        ...
                                        if (!arrivalMonthSelect.value || !arrivalDaySelect.value || !arrivalYearSelect
                                            ...
                                            'Full Arrival Date is required.'); // Generic error for date group
                                            showError(arrivalDaySelect,
                                            ''); // Clear specific day error if month/year are missing
                                            showError(arrivalYearSelect,
                                            ''); // Clear specific year error if month/day are missing
                                            isValid = false;
                                        } else {
