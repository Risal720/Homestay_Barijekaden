<x-controlpanel>
    ...
    <div class="container mx-auto p-6">
        ...
        @endif --}}
        {{-- Flash messages should ideally be handled by a layout component or Alpine.js for better UX --}}
        {{-- For now, commenting them out to avoid undefined styles if CSS is not loaded globally --}}

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {{-- Kartu Manajemen Kamar --}}
            ...
            {{-- Kartu Manajemen Pengguna - DIPERBAIKI --}}
            <a href="{{ route('admin.users.index') }}" class="block bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:-translate-y-1">
            ...
            {{-- Kartu Laporan & Statistik - DIPERBAIKI --}}
            <a href="{{ route('admin.reports.sales') }}" class="block bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:-translate-y-1">
